            ...
            >
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="w-14 h-14 bg-orange-500/10 rounded-2xl flex items-center justify-center shrink-0">
                  <RefreshCcw className="text-orange-400 w-7 h-7" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4 tracking-tight">Non-Refundable Policy</h2>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4 tracking-tight">Service Delivery</h2>
                  <p className="text-lg text-white/70 leading-relaxed">
                    Once a business is upgraded and verified, the service is considered delivered and final.
                  </p>
                </div>
              </div>
            </motion.div>
